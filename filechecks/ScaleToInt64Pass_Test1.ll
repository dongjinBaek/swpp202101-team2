; ModuleID = '/tmp/a.ll'
source_filename = "filechecks/Int32To64Pass_Test1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define dso_local i32 @main() #0 {
; i32 load/store with malloc
; Check doubled malloc size
; Check doubled offset
; CHECK: main
; CHECK: r[[#R1:]] = mul 28 2 64
; CHECK: malloc r[[#R1]]
; CHECK: mul 3 2
entry:
  %call = call noalias i8* @malloc(i64 28) #4
